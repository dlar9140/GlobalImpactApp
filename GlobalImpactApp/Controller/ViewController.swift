...
extension MKMapView
{
    ...
    {
        MKMapView.animate(withDuration: duration, delay: 0, usingSpringWithDamping: 0.6, initialSpringelocity: options: UIView.AnimationOptions.curveEaseIn, animations:
